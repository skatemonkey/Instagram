import { collection, onSnapshot, addDoc, serverTimestamp, query, orderBy, setDoc, doc, deleteDoc } from "@firebase/firestore";
import {
    BookmarkIcon,
    ChatIcon,
    DotsHorizontalIcon,
            ...
            {session && (
                <form className="flex items-center p-4">
                    ...
                    <input
                        ...
                        className="border-noone flex-1 focus:ring-0 outline-none"
                    />
                    <button 
                        type='submit'
